...
class ElectraClassifier(nn.Module):
    def __init__(self,num_labels=2):
        ...
        # network features
        self.network_input = nn.Linear(in_features=14,out_features=256) # 14 network features
        ...
        # self.dense_net_core1 = nn.Linear(in_features=2048,out_features=2048)
        # self.dense_net_core2 = nn.Linear(in_features=2048,out_features=2048)
        # self.dense_net_core3 = nn.Linear(in_features=2048,out_features=2048)
        # self.dense_net_core4 = nn.Linear(in_features=2048,out_features=2048)
    ...
    def forward(self,network_features=None):
        ...
        # x_net = F.relu(self.dense_net_core1(x_net))
        # x_net = F.relu(self.dense_net_core2(x_net))
        # x_net = F.relu(self.dense_net_core3(x_net))
        # x_net = F.relu(self.dense_net_core4(x_net))
