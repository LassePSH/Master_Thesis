...
class ElectraClassifier(nn.Module):
    def __init__(self,num_labels=2):
        ...
        self.dense_net2 = nn.Linear(in_features=256,out_features=1024)
        ...
        self.dense_net6 = nn.Linear(in_features=1024,out_features=256)
        self.dropout_net = nn.Dropout()

        # combined features
        self.dense_cat1 = nn.Linear(in_features=512,out_features=512) # 256 from text features + 256 from network features = 512
        ...
        self.dense_cat5 = nn.Linear(in_features=2048,out_features=1024)
        self.dense_cat6 = nn.Linear(in_features=1024,out_features=512)
    ...
    def classifier(self,sequence_output,network_features):
        ...
        # x = F.gelu(self.dense_cat5(x))
        # x = F.gelu(self.dense_cat6(x))
